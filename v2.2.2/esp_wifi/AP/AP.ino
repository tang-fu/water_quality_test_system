...
SoftwareSerial Spresense_Port(D6, D5);  // rx tx
            ...
            case 'S':  //系统正常工作
              {
                ...
                Serial.println("/*****************************************************/");
                Spresense_Port.print(temp);
                while (1) {
                  Spresense_Port.print("s");
                  delay(1500);
                  while (Spresense_Port.available() > 0) {
                    temp = Spresense_Port.read();
                    if (temp == '\n') {
                      break;
                    } else {
                      box += temp;
